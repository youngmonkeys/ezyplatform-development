...
public final class CommonConstants {
    ...
    public static final int MAX_ACTIVITY_HISTORY_PARAMETERS_LENGTH = 600;
    public static final int MAX_MEDIA_URL_LENGTH = 300;
    public static final int MAX_MEDIA_ORIGINAL_NAME_LENGTH = 300;
    public static final int MAX_MEDIA_TITLE_LENGTH = 300;
    public static final int MAX_MEDIA_CAPTION_LENGTH = 300;
    ...
    public static final String COOKIE_NAME_MARKET_SSO_URL = "marketSsoUrl";
