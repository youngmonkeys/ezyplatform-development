 ...
 */
public abstract class CommonPaginationResultService<
    T,
    F extends CommonStorageFilter,
    P extends CommonPaginationParameter,
    I,
    E,
    R> extends DefaultPaginationResultService<T, F, P, I, E, R> {

    protected final ComplexPaginationParameterConverter<String, T>
        paginationParameterConverter;

    public CommonPaginationResultService(
        PaginationResultRepository<F, P, I, E, R> repository,
