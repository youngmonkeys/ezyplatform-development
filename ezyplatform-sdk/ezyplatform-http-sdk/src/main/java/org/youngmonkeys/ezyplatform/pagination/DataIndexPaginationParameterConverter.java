...
public class DataIndexPaginationParameterConverter
    ...
    protected void mapPaginationParametersToTypes(
        ...
        map.put(
            DataIndexPaginationSortOrder.DATA_ID_DESC.toString(),
            DataIdDescDataIndexPaginationParameter.class
        );
    }

    @Override
    protected void addPaginationParameterExtractors(
        Map<String, Function<Long, Object>> map
    ) {
        map.put(
            DataIndexPaginationSortOrder.DATA_ID_DESC.toString(),
            DataIdDescDataIndexPaginationParameter::new
        );
    }
}
