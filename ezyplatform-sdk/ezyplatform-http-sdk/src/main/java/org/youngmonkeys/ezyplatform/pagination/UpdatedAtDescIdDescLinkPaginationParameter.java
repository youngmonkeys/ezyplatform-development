...
@NoArgsConstructor
@AllArgsConstructor
public class UpdatedAtDescIdDescLinkPaginationParameter
    implements LinkPaginationParameter {
    ...
    public String orderBy(boolean nextPage) {
        return makeOrderByDesc(nextPage, "updatedAt", "id");
    }

    @Override
    public boolean isEmpty() {
        return isAllNull(updatedAt, id);
    }

    @Override
    public String sortOrder() {
        return LinkPaginationSortOrder
