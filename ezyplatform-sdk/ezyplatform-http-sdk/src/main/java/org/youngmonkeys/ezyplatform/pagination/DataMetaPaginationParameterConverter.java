...
public class DataMetaPaginationParameterConverter
    extends ComplexPaginationParameterConverter<
        String,
        DataMetaModel
    > {

    public DataMetaPaginationParameterConverter(
    ...
    protected void mapPaginationParametersToTypes(
        ...
        map.put(
            DataMetaPaginationSortOrder.ID_ASC.toString(),
            IdAscDataMetaPaginationParameter.class
        );
        map.put(
            DataMetaPaginationSortOrder.ID_DESC.toString(),
            IdDescDataMetaPaginationParameter.class
        );
        map.put(
    ...
    protected void addPaginationParameterExtractors(
        Map<String, Function<DataMetaModel, Object>> map
    ) {
        map.put(
            DataMetaPaginationSortOrder.ID_ASC.toString(),
            model -> new IdAscDataMetaPaginationParameter(
                model.getId()
            )
        );
        map.put(
            DataMetaPaginationSortOrder.ID_DESC.toString(),
            model -> new IdDescDataMetaPaginationParameter(
                model.getId()
            )
        );
        map.put(
