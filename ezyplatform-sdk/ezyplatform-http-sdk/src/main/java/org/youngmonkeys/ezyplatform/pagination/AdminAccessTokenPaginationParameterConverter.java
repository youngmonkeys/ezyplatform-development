...
public class AdminAccessTokenPaginationParameterConverter
    extends ComplexPaginationParameterConverter<
        String,
        AdminAccessTokenModel
    > {

    public AdminAccessTokenPaginationParameterConverter(
    ...
    protected void mapPaginationParametersToTypes(
        ...
        map.put(
            ...
            IdDescAdminAccessTokenPaginationParameter.class
        );
    }

    @Override
    protected void addPaginationParameterExtractors(
        Map<String, Function<AdminAccessTokenModel, Object>> map
    ) {
        map.put(
            AdminAccessTokenPaginationSortOrder.ID_DESC.toString(),
