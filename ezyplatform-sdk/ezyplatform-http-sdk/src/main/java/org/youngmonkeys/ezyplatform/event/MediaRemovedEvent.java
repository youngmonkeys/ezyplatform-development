...
public class MediaRemovedEvent {
    ...
    protected MediaRemovedEvent(Builder builder) {
    ...
    public static class Builder implements EzyBuilder<MediaRemovedEvent> {
        ...
        @Override
        public MediaRemovedEvent build() {
            return new MediaRemovedEvent(this);
        }
    }
}
