...
public class UserRoleNamePaginationParameterConverter
    ...
    protected void mapPaginationParametersToTypes(
        ...
        map.put(
            UserRoleNamePaginationSortOrder.PRIORITY_ASC_ID_ASC.toString(),
            PriorityAscIdAscUserRoleNamePaginationParameter.class
        );
        map.put(
            UserRoleNamePaginationSortOrder.PRIORITY_DESC_ID_DESC.toString(),
            PriorityDescIdDescUserRoleNamePaginationParameter.class
        );
    }
    ...
    protected void addPaginationParameterExtractors(
        ...
        map.put(
            UserRoleNamePaginationSortOrder.PRIORITY_ASC_ID_ASC.toString(),
            model -> new PriorityAscIdAscUserRoleNamePaginationParameter(
                model.getPriority(),
                model.getId()
            )
        );
        map.put(
            UserRoleNamePaginationSortOrder.PRIORITY_DESC_ID_DESC.toString(),
            model -> new PriorityDescIdDescUserRoleNamePaginationParameter(
                model.getPriority(),
                model.getId()
            )
        );
