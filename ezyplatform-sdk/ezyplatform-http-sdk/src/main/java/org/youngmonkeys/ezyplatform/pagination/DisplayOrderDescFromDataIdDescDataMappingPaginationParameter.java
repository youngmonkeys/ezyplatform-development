...
@NoArgsConstructor
@AllArgsConstructor
public class DisplayOrderDescFromDataIdDescDataMappingPaginationParameter
    ...
    public String orderBy(boolean nextPage) {
        return makeOrderByDesc(nextPage, "displayOrder", "fromDataId");
    }

    @Override
    public boolean isEmpty() {
        return isAllNull(displayOrder, fromDataId);
    }
