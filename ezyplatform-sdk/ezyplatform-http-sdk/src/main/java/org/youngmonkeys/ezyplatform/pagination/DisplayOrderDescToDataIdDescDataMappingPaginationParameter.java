...
@NoArgsConstructor
@AllArgsConstructor
public class DisplayOrderDescToDataIdDescDataMappingPaginationParameter
    ...
    public String orderBy(boolean nextPage) {
        return makeOrderByDesc(nextPage, "displayOrder", "toDataId");
    }

    @Override
    public boolean isEmpty() {
        return isAllNull(displayOrder, toDataId);
    }
