...
public class ValidateMediaOwnerEvent {
    ...
    protected ValidateMediaOwnerEvent(Builder builder) {
    ...
    public static class Builder implements EzyBuilder<ValidateMediaOwnerEvent> {
        ...
        @Override
        public ValidateMediaOwnerEvent build() {
            return new ValidateMediaOwnerEvent(this);
        }
    }
}
