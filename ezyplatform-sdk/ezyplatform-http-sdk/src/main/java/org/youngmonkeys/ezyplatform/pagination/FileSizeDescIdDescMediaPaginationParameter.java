...
@NoArgsConstructor
@AllArgsConstructor
public class FileSizeDescIdDescMediaPaginationParameter
    implements MediaPaginationParameter {
    ...
    public String orderBy(boolean nextPage) {
        return makeOrderByDesc(nextPage, "fileSize", "id");
    }

    @Override
    public boolean isEmpty() {
        return isAllNull(fileSize, id);
    }

    @Override
    public String sortOrder() {
        return MediaPaginationSortOrder
