...
public class MediaAddedEvent {
    ...
    protected MediaAddedEvent(Builder builder) {
    ...
    public static class Builder implements EzyBuilder<MediaAddedEvent> {
        ...
        @Override
        public MediaAddedEvent build() {
            return new MediaAddedEvent(this);
        }
    }
}
